...
<section class="hero-section">
    <div class="hero-inner container">
        ...
        <div class="kakao-floating">
            ...
            <a href="http://pf.kakao.com/_xiZTVX" target="_blank" class="k-button">
    ...
    <div class="container">
        ...
        <div class="business-grid">
            ...
            <a href="<?php echo G5_URL ?>/page/product1_8.php" class="b-card">
                <div class="b-img"><img src="<?php echo G5_THEME_URL ?>/img/bus_2_ai.png" alt="자동제어반"></div>
                <div class="b-content">
                    <h4>자동제어반</h4>
            ...
            <a href="<?php echo G5_URL ?>/page/product_business.php" class="b-card">
                <div class="b-img"><img src="<?php echo G5_THEME_URL ?>/img/bus_3_ai.png" alt="자동화 설비"></div>
                <div class="b-content">
                    <h4>자동화 설비</h4>
            ...
            <a href="<?php echo G5_URL ?>/page/estimate.php" class="b-card">
                <div class="b-img"><img src="<?php echo G5_THEME_URL ?>/img/bus_4_ai.png" alt="유지보수"></div>
                <div class="b-content">
                    <h4>유지보수</h4>
...
<section class="footer-cta">
    <div class="container f-cta-inner">
        ...
        <div class="f-cta-btns">
            ...
            <a href="http://pf.kakao.com/_xiZTVX" target="_blank" class="btn-cta-k">
