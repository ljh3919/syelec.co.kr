...
// }
    ...
    function hover_scroll_2 (_this) {
        ...
        function rowspan_check_num(_this){
            ...
            if($(_this).attr('rowspan') != undefined){ //'̿�����'
                set_num = 1;
            } else { //'̿�����'
                if($(_this).prev().attr('rowspan') != undefined){ //'�ҪȪ����̿�����'
                    set_num = 1;
                } else { //'�ҪȪ����̿�����'
                    if($(_this).parent().prev().find('th').attr('rowspan') != undefined ) { //'߾���Ѫ�̿�����'
                        set_num = 2;
                    } else {//'߾���Ѫ�̿�����'
                        set_num = 0;
                    }
...
.each(function(index,element){
    ...
    //�ޫ�����?��? 15/11/27 ����
    $('.over').hover(
        function(){ mouthOver(this); }, //�۫�?������
        function(){ mouthOver(this); } //�۫�?��𶪷����
    );
