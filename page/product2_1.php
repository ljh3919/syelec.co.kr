...
<div id="article_right">
    ...
    <div id="article">
      <div class="product">
        <ul>
            <li><a href="javascript:menu3sub2();">배전용 유입변압기</a></li>
            <li class="on"><a href="javascript:menu3sub2_2();">배전용 몰드변압기</a></li>
          </ul>
          
          <p class="product_title">배전용 몰드변압기</p>
          ...
          <div class="product_detail">
            <div class="product_detail_left">
              <p class="product_title2"></p>
                  <ul>
                    <li>정격용량 : 100 ~ 20,000kVA</li>
                    <li>정격전압 : 220V ~ 36,000V</li>
                    <li>생산능력 : 5,000MVA</li>
                  </ul>
              </div>
            <div class="product_detail_right">
              <img src="../images/product6-photo-2.jpg" width="300px">
              </div>
          </div>
